# Generated by Django 4.2.7 on 2024-02-13 07:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ModalCount',
            fields=[
                ('code', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='modal_count', serialize=False, to='config.segment')),
                ('name', models.CharField(max_length=255)),
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ('duration', models.IntegerField()),
        ...
        migrations.AddField(
            model_name='phase',
            name='item_code',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='banana', to='config.modalcount'),
        ),
        migrations.CreateModel(
            name='OrderItems',
            fields=[
